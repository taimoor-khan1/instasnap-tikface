...
import {height, STYLES, SIZES, SCREENS, COLORS} from '../../constants';
...
export default function EditPhoto(props) {
  ...
  const [selectPhoto, setSelectPhoto] = useState(item);
  ...
  return (
    <View style={[STYLES.container, {paddingTop: 0}]}>
      <ImageBackground
        ...
        <CustomHeader
          hasBackArrow
          containerStyle={{marginTop: StatusBar.currentHeight * 1.5}}
        />
        <View style={styles.topRow}>
          <View style={{flexDirection: 'row'}}>
            <EditIcons name="crop" type={IconType.Feather} />
            <EditIcons name="contrast" type={IconType.Ionicons} />
            <EditIcons name="magic" type={IconType.FontAwesome} />
          </View>
          <CommonButton
      ...
      PhotoEditor.Edit({
   path: RNFS.DocumentDirectoryPath + uri: selectPhoto.imgURL,
...
const styles = StyleSheet.create({
  ...
  btnStyle: {
    paddingHorizontal: SIZES.twentyFive * 1.4,
  },
});
